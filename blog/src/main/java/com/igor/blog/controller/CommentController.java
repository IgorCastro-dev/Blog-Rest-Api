...
public class CommentController {
	...
	private ResponseEntity<String> deleteCommentByPostId(@PathVariable("postId") Long postId,@PathVariable("commentId") Long commentId){
		commentService.deleteCommentByPostId(postId,commentId);
		return new ResponseEntity<>("Comment was delected",HttpStatus.OK);
	}
}
